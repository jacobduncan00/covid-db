...
<div style="margin: auto; margin-top: 20px; text-align: left; width: max-content; background-color: #A80000; border: 2px solid black; border-radius: 10px; padding-left: 20px; padding-right: 20px;">
';
...
$output .= '<div style="margin: auto; text-align: left; width: max-content; background-color: #A80000; border: 2px solid black; border-radius: 10px; padding-left: 20px; padding-right: 20px;">';
# Amount of Students 
$query = "SELECT COUNT(ID) as total FROM Student"; 
$result = mysqli_query($connect, $query);
$result2 = mysqli_fetch_array($result);
$output .= '<h1># of Students: <span style="color: #FFCC44">' . $result2['total'] . '</span></h1>';
$output .= "</div>";
$output .= '<br/>';
...
$output .= '<div style="margin: auto; text-align: left; width: max-content; background-color: #A80000; border: 2px solid black; border-radius: 10px; padding-left: 20px; padding-right: 20px;">';
# Amount of Faculty 
$query = "SELECT COUNT(ID) as total FROM Faculty"; 
$result = mysqli_query($connect, $query);
$result2 = mysqli_fetch_array($result);
$output .= '<h1># of Faculty: <span style="color: #FFCC44">' . $result2['total'] . '</span></h1>';
$output .= "</div>";
$output .= '<br/>';
...
$result = mysqli_query($connect, $query);
$result2 = mysqli_fetch_array($result);
$output .= '<h1># of Staff: <span style="color: #FFCC44">' . $result2['total'] . '</span></h1>';
$output .= "</div>";
